...
def get_baseargs():
    ...
    parser.add_argument("--clip-path", type=str, default="/home/user/Projects/ViT-B-32.pt", help="pretrained clip path.")
    parser.add_argument("--pretrained", type=str, default="")
    parser.add_argument("--dataset", type=str, default="flickr", help="choice from [flickr, nuswide, coco, iapr]")
